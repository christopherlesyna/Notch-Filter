...
//-----------------------------------------------------------------------------
#define BUFFSIZE 24000
#define FIRSIZE 15
#define IIRSIZE 3  //for notch
#define IIRSIZE 10  //for multirate
#define LEFT     0
#define RIGHT     1
...
// Externs
//-----------------------------------------------------------------------------
extern int16_t echo_buff_l[BUFFSIZE];
extern int16_t echo_buff_r[BUFFSIZE];

extern int16_t buff_fir_l[FIRSIZE];
extern int16_t buff_fir_r[FIRSIZE];

extern int16_t buff_iir_x_l[IIRSIZE];
extern int16_t buff_iir_x_r[IIRSIZE];
extern int16_t buff_iir_y_l[IIRSIZE];
extern int16_t buff_iir_y_r[IIRSIZE];

extern uint16_t leftRight;
