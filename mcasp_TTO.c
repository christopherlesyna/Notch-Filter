...
/*
   ...
   MCASP->ACLKRCTL   = 0x000000AF; //MCASP->ACLKRCTL   = 0x000000AF;
   MCASP->AHCLKRCTL  = 0x00008005;
   ...
   MCASP->XFMT       = 0x0001807C;
   MCASP->AFSXCTL    = 0x00000112;
   MCASP->ACLKXCTL   = 0x000000AF; //MCASP->ACLKXCTL   = 0x000000AF;
   MCASP->AHCLKXCTL  = 0x00008005;
   MCASP->XTDM       = 0x00000003;
   MCASP->XINTCTL    = 0x00000000;
   MCASP->XCLKCHK    = 0x00FF0008;
